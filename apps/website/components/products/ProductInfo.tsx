    ...
    return (
        <div className="bg-white space-y-6">
            ...
            {isOwner ? (
                ...
                <>
                    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-[1001] grid grid-cols-2 gap-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] md:shadow-none md:static md:bottom-auto md:left-auto md:right-auto md:p-0 md:bg-transparent md:border-none md:z-auto md:mt-4">
                        <button
